...
- **중 (보통)**: 여러 단계 필요, 중간 수준의 계획, 몇 주~몇 달
- **상 (복잡)**: 장기 프로젝트, 다양한 요소 고려, 여러 달~년 단위
...
### 복잡도 판단 예시
- **하**: 제품 구매, 간단한 여행, 취미 시작, 일회성 이벤트
- **중**: 자격증 취득, 다이어트, 부업 시작, 기술 학습
- **상**: 이직/창업, 해외 이민, 대학원 진학, 사업 확장
